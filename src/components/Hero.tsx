      ...
      <div className="container mx-auto px-4 py-20">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 space-y-6 animate-fade-in">
            ...
            <Button
              className="bg-primary hover:bg-primary/90 text-white px-8 py-6 text-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary/20"
              asChild
            >
          ...
          <div className="md:w-1/2 mt-10 md:mt-0">
            <img
              ...
              className="w-full h-auto object-contain transition-all duration-500 hover:scale-105 animate-fade-in"
            />
          </div>
        </div>
      </div>
